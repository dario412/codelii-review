...
export const PM_PROVIDERS = {
  asana: {
    ...
    name: 'Asana',
    category: 'pm',
    blurb: 'Create Asana tasks from feedback so delivery stays in your workflow.',
    color: '#F06A6A',
    comingSoon: false,
  ...
  linear: {
    ...
    name: 'Linear',
    category: 'pm',
    blurb: 'Turn review comments into Linear issues for your eng team.',
    color: '#5E6AD2',
    comingSoon: false,
  ...
  monday: {
    ...
    name: 'Monday.com',
    category: 'pm',
    blurb: 'Push feedback into Monday boards as actionable items.',
    color: '#FF3D57',
    comingSoon: false,
  ...
  jira: {
    ...
    name: 'Jira',
    category: 'pm',
    blurb: 'Open Jira issues from review pins for teams on Atlassian.',
    color: '#2684FF',
    comingSoon: false,
  ...
  notion: {
    ...
    name: 'Notion',
    category: 'pm',
    blurb: 'Add review comments as Notion database tasks or pages.',
    color: '#FFFFFF',
    comingSoon: false,
