  ...
  return json({
    integrations: {
      slack: {
        ...
        category: 'notify',
        name: 'Slack',
        blurb: 'Send new comments, @mentions, assignments, and page approvals into a channel your team already watches.',
      },
      teams: {
        available: true,
        ...
        blurb: 'Mirror the same review updates into a Teams channel for clients who live in Microsoft 365.',
      },
      discord: {
        available: true,
        ...
        category: 'notify',
        name: 'Discord',
        blurb: 'Pipe review activity into a Discord channel — ideal for product and engineering rooms.',
      },
      digest: {
        ...digest,
        category: 'notify',
        name: 'Email digest',
        blurb: 'A calm daily or weekly summary of open comments across every project you own.',
      },
      ...pm,
      github: {
        id: 'github',
        name: 'GitHub Issues',
        blurb: 'Turn any review comment into a GitHub issue when a repo is linked to the project.',
        category: 'pm',
        available: true,
        connected: false,
        comingSoon: false,
        note: 'Create issues from any comment once a GitHub repo is linked on the project.',
      },
    },
  });
}
