...
const API_ROUTES = {
  ...
  'GET /api/digest': () => import('../api/digest.js'),
  'POST /api/digest': () => import('../api/digest.js'),
  'OPTIONS /api/digest': () => import('../api/digest.js'),
  ...
  'GET /api/teams-callback': () => import('../api/teams-callback.js'),
  'OPTIONS /api/teams-callback': () => import('../api/teams-callback.js'),
